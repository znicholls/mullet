...
Defined at scm_state.fpp lines 5-18
...
def get_dat_rf_total():
    ...
    Defined at scm_state.fpp line 14
    
    """
    global dat_rf_total
    dat_rf_total_handle = _test_scm_pkg.f90wrap_scm_state__get__dat_rf_total()
...
def set_dat_rf_total(dat_rf_total):
    ...
    _test_scm_pkg.f90wrap_scm_state__set__dat_rf_total(dat_rf_total)
...
try:
    ...
    logging.debug('unallocated array(s) detected on import of module "scm_state".')
